...
!function(n, i) {
    ...
    var e = function(n) {
        ...
        e.supportsTransitionEnd() && (n.event.special[e.TRANSITION_END] = {
            bindType: i.end,
            delegateType: i.end,
            handle: function(i) {
        ...
        var i = "metisMenu"
          ...
          , c = function() {
            ...
            return i.prototype.init = function() {
                ...
                n(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(l.CLICK_DATA_API, function(t) {
                    var e = n(this)
            ...
            i.prototype._show = function(i) {
                if (!this._transitioning && !n(i).hasClass(this._config.collapsingClass)) {
                    ...
                    !o.isDefaultPrevented()) {
                        ...
                        this._config.toggle && this._hide(s.parent(this._config.parentTrigger).siblings().children(this._config.subMenu + "." + this._config.collapseInClass).attr("aria-expanded", !1)),
                        s.removeClass(this._config.collapseClass).addClass(this._config.collapsingClass).height(0),
                        this.setTransitioning(!0);
                        var a = function() {
                            t._config && t._element && (s.removeClass(t._config.collapsingClass).addClass(t._config.collapseClass + " " + t._config.collapseInClass).height("").attr("aria-expanded", !0),
            ...
            i.prototype._hide = function(i) {
                if (!this._transitioning && n(i).hasClass(this._config.collapseInClass)) {
                    ...
                    !o.isDefaultPrevented()) {
                        ...
                        s.addClass(this._config.collapsingClass).removeClass(this._config.collapseClass).removeClass(this._config.collapseInClass),
                        this.setTransitioning(!0);
                        var a = function() {
                            t._config && t._element && (t._transitioning && t._config.onTransitionEnd && t._config.onTransitionEnd(),
                            t.setTransitioning(!1),
                            s.trigger(l.HIDDEN),
                            s.removeClass(t._config.collapsingClass).addClass(t._config.collapseClass).attr("aria-expanded", !1))
                        };
            ...
            i._jQueryInterface = function(e) {
                return this.each(function() {
                    ...
                    if (!a && /dispose/.test(e) && this.dispose(),
                    a || (a = new i(this,l),
                    o.data(s, a)),
                    "string" == typeof e) {
                        if (void 0 === a[e])
